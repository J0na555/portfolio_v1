...
// the glitch effect is inspired by the following code:
// https://codepen.io/MoeSadek/pen/ZELxLW
const LetterGlitch = ({
  ...
  const lettersAndSymbols = [' ሀ ',' ለ ',' ሐ ',' መ ',' ሠ ',' ረ ',' ሰ ',' ሸ ',' ቀ ',' በ ',' ቨ ',' ተ ',' ቸ ',' ኀ ',' ነ ',' ኘ ',' አ ',' ከ ',' ኸ ',' ወ ',' ዐ ',' ዘ ',' ዠ ',' የ ',' ደ ',' ጀ ',' ገ ',' ጠ ',' ጨ ',' ጰ ',' ጸ ',' ፀ ',' ፈ ',' ፐ ',' ቈ ',' ኈ ',' ኰ ',' ዀ ',' ጐ ',' ፩ ',' ፪ ',' ፫ ',' ፬ ',' ፭ ',' ፮ ',' ፯ ',' ፰ ',' ፱ ',' ፲ ',' ፳ ',' ፴ ',' ፵ ',' ፶ ',' ፷ ',' ፸ ',' ፹ ',' ፺ ',' ፻ ',' ፼ ',' ፡ ',' ። ',' ፣ ',' ፤ ',' ፥ ',' ፦ ',' ፧ ',' ፨ ',' ፠ ']
